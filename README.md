# Sistema de Escala de Limpeza - Formare 2025
...
- **Flask** (Backend): API para fornecimento de dados dinâmicos da escala de limpeza. (APIs Pythonanywhwre expostas apenas para fins educacionais)
